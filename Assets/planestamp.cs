...
public class planestamp : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (serial == "up") GameObject.Find("stamp").transform.position += new Vector3(0, 0.98f, 0);
        if (serial == "down") GameObject.Find("stamp").transform.position -= new Vector3(0, 0.98f, 0);
        if (serial == "left") GameObject.Find("stamp").transform.position += new Vector3(1.7424f, 0, 0);
        if (serial == "right") GameObject.Find("stamp").transform.position -= new Vector3(1.7424f, 0, 0);
        if (serial == "guess")
        {
